...
### 🌟 Project 1 — GlowCo: Health, Wellness \& Beauty Ecommerce Dashboard
...
!\[GlowCo Executive Summary](GlowCo%20Ecommerce/screenshots/01\_executive\_summary.png)
...
### Project 2 — British Airways Customer Review Analysis

[**View Project →**](https://github.com/frazbama/daportfolio/tree/main/British%20Airways)

Tableau dashboard analysing British Airways customer review data — exploring satisfaction scores, service ratings and sentiment trends across routes and cabin classes.

**Tools:** Tableau
**Sector:** Aviation · Customer Analytics

\---

### Project 3 — London Bike Rides Analysis

[**View Project →**](https://github.com/frazbama/daportfolio/tree/main/London%20Bike%20Rides)

Tableau dashboard analysing London bike sharing data with heat maps and moving averages — identifying usage patterns, peak periods and weather impact on ridership.

**Tools:** Tableau
**Sector:** Transportation · Urban Analytics

\---

### Project 4 — Victoria BC Airbnb Market Analysis

[**View Project →**](https://github.com/frazbama/daportfolio/tree/main/Victoria%20BC%20Airbnb)

Tableau dashboard exploring Airbnb accommodation data for Victoria, BC — analysing pricing, availability, neighbourhood distribution and host performance metrics.

**Tools:** Tableau
**Sector:** Real Estate · Hospitality Analytics

\---

### Project 5 — Bellabeat Smart Device Case Study
